...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public DataLoader(CategoryRepo categoryRepository, RecipeRepo recipeRepository, UnitOfMeasurementRepo unitOfMeasureRepository) {
        log.debug("This is dataLoader class");
